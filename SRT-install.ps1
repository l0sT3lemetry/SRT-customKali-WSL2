...
Write-Host "Downloading WSL Kernel and installing.`n"
# This is just preference for the most part
cd ~\desktop
Invoke-Webrequest -Uri https://wslstorestorage.blob.core.windows.net/wslblob/wsl_update_x64.msi -outfile wsl_update_x64.msi
msiexec /package wsl_update_x64.msi /passive /norestart
...
Run wsl, and follow the following guide to configure your interfaces if you are using WSL2: 
https://support.synack.com/hc/en-us/articles/10656258703379-LP-Setting-up-Kali-via-WSL2" -ForegroundColor Cyan
